...
Revision ID: 940e1dc69d68
Revises: 
Create Date: 2024-05-15 13:53:09.641913+03:30
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_client_latestHandshakeAt"),
        "client",
        ["latestHandshakeAt"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_client_updated_at"), "client", ["updated_at"], unique=False
    )
